...
*This document was auto-generated from a full source analysis of the AAI_M5 deployment package. All code references, configuration values, algorithm descriptions, and security control details are derived directly from the source files.*
