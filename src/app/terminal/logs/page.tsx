  ...
  return (
    <div className="px-8 py-8 space-y-6 max-w-7xl mx-auto w-full">
      ...
      <div className="flex justify-between items-start flex-wrap gap-4">
        <div>
          <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Terminal Event Logs</h2>
          <p className="text-slate-500 mt-1 text-sm">
            Reviewing terminal transaction and audit logs.
          </p>
        </div>
        <div className="flex space-x-3">
          <button
            onClick={handleExport}
            className="px-4 py-2 border border-slate-300 rounded-md text-sm font-semibold text-slate-700 bg-white hover:bg-slate-50 flex items-center shadow-sm cursor-pointer transition-colors font-mono"
          >
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 rounded-md text-sm font-semibold text-white hover:bg-blue-700 flex items-center shadow-sm cursor-pointer transition-colors font-mono"
          >
